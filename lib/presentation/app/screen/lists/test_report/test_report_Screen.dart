...
class _TestReportScreenState extends State<TestReportScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              getBackAppBar(
                  ...
                  actionClick: () {
                    var url =
                        "${controller.bookingResponse.value!.pdfBaseURL}${controller.report.value!.report}";
                    launchPDF(url);
                  }),
              getVerSpace(20.h),
              Expanded(
  ...
  Widget buildTestInfoView() {
    var report = controller.report.value;
    return Row(
      children: [
        Container(
          height: 102.h,
        ...
        Column(
          ...
          children: [
            ...
            getVerSpace(10.h),
            buildDateTimeRow('${Constant.changeDateFormat(report.createdAt!)},',
                '${Constant.changeDateFormat(report.createdAt!, changeInto: 'HH:mm')}')
          ],
        )
      ],
    ...
    return Column(
      ...
      children: [
        getCustomFont("Beneficiary :", 15.sp, greyFontColor, 1,
            fontWeight: FontWeight.w500),
        getVerSpace(6.h),
        getRichText(report!.labs!.name!, Colors.black, FontWeight.w500, 17.sp,
            "(Lab)", greyFontColor, FontWeight.w500, 16.sp),
